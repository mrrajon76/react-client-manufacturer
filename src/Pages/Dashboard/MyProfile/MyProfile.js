...
const MyProfile = () => {
    ...
    const { isLoading, data } = useQuery('userDetails', () =>
    ...
    return (
        <div className='mx-6 md:mx-10 my-6 md:my-10 lg:m-0'>
            ...
            <div className='mt-10 mx-auto lg:mx-0 w-full md:w-2/3'>
                {
                ...
                <Link to='/'><button className='block mx-auto lg:mx-0 bg-primary text-white hover:bg-secondary py-2 px-8 uppercase font-semibold rounded transition hover:scale-105 duration-500'>Update Information</button></Link>
            </div>
        </div>
    );
};
